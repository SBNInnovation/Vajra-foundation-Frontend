  ...
  return (
    <>
        <div className='w-full flex items-center justify-center h-[60vh] relative' style={{background:"url('/env-4.webp')",backgroundAttachment:"fixed",backgroundPosition:"center",backgroundSize:"cover"}}>
                ...
                <h1 className='text-white font-bold lg:text-6xl text-xl z-[99]'>Our Success in Environment</h1>   
        </div>
        <div className='w-full items-center justify-center flex flex-col gap-4 my-12 lg:px-16 px-4 text-justify leading-8'>
            ...
            <div className='flex lg:flex-row flex-col gap-8 w-full'>
                <div className='lg:w-1/2 w-full lg:h-[400px] h-[300px]'>
            ...
            <Image src={'/env-2.webp'} alt='Health' height={1000} width={1000} className='object-cover lg:h-[500px] h-[300px] lg:w-4/5 w-full rounded-md shadow-md'/>
                <p className='text-justify lg:text-lg text-sm lg:leading-10 leading-6 text-gray-700'>
    ...
    <br /> <br />The foundation is also actively involved in tree planting and environmental cleanup efforts, working with local communities to restore forests, protect biodiversity, and improve life in rural areas. Through these programs, Vajra Foundation is creating a cleaner, greener Nepal.
            ...
            <div className='flex lg:flex-row flex-col gap-4 w-full'>
                <div className='lg:w-1/2 w-full h-[300px] lg:h-[500px]'>
