...
const Donation = () => {
    return (
        ...
        <div className='w-full flex items-center justify-center h-[60vh] relative' style={{background:"url('/help.avif')",backgroundAttachment:"fixed",backgroundPosition:"center",backgroundSize:"contain"}}>
                ...
                <h1 className='text-white font-bold text-6xl z-[99]'>Donation</h1>   
            </div>

        <div className='flex gap-12 justify-center items-start my-12 w-full px-16'>
            <div className='flex flex-col w-1/2'>
                <SharedTitle title='Donation' />
                <h1 className='font-semibold text-2xl'>Together we can make a difference</h1>
                <LineDot/>
