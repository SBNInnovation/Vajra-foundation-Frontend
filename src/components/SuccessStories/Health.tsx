...
const Health = () => {
  return (
    <>
        <div className='w-full flex items-center justify-center h-[60vh] relative' style={{background:"url('/healthBG.JPG')",backgroundAttachment:"scroll",backgroundPosition:"top",backgroundSize:"cover"}}>
